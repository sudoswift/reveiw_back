    ...
    <hr>
        ...
        <div style="text-align: center;">
            <div style="margin-bottom: 3rem;">
                <h2><strong><개인정보이용방침 안내></strong></h2>
            </div>
            <div>
                <p>이 페이지는 대학교 과제 제출용으로 만들어졌으며</p>
                <p>사용자의 어떠한 정보도 수집하지 않음</p>
                <p>login.html, accounts.html 역시 그러하며</p>
                <h3 style="color: red;"><u>따라서</u></h3>
                <p><span style="color: red;">해당 폼에 어떠한 개인정보도 작성하지 말 것을 강하게 당부하며</span></p>
                <p><span style="color: red;">임의로 제출한 정보가 유출 및 악용 되어도</span></p>
                <p><span style="color: red;">페이지 제작자는 모든 책임이 없음을 알림</span></p>
            </div>
        </div>
    <!-- 이후로 footer -->
    <hr>
